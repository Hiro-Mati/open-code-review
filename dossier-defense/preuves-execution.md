...
| #1474 | ✅ Prouvé | `TestExecuteGroupSubtask_LaterRoundStopKeepsCompletion`, `TestDispatchSubtasks_RenamedFileCommentOnOldPath`, `TestExecuteGroupSubtask_PathlessCommentInGroup/unlocatable_is_dropped`, `TestExecuteToolCall_CodeCommentRenamedOldPath`, `TestExecuteToolCall_CodeCommentGroupKeyFallbackDropped` |
...
| #1481 | ✅ Prouvé | `TestSetConfigValueProviderRejectsEmptyName` (3 sous-tests), `TestResolveConfig` (sous-tests `"0"`, `"false"`, `"FALSE"`) |
...
| #1431 | ✅ Prouvé | `TestGitGrep_CRLFFileHasNoTrailingCR`, `TestFileFind_NonASCIIPath` |
...
**18 PR sur 20 sont prouvées par un test qui échoue sans elles.**
